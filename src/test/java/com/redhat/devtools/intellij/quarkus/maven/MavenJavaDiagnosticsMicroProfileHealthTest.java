...
import static com.redhat.devtools.intellij.quarkus.module.MicroProfileForJavaAssert.assertJavaCodeAction;
import static com.redhat.devtools.intellij.quarkus.module.MicroProfileForJavaAssert.assertJavaDiagnostics;
import static com.redhat.devtools.intellij.quarkus.module.MicroProfileForJavaAssert.ca;
import static com.redhat.devtools.intellij.quarkus.module.MicroProfileForJavaAssert.d;
import static com.redhat.devtools.intellij.quarkus.module.MicroProfileForJavaAssert.te;
...
public class MavenJavaDiagnosticsMicroProfileHealthTest extends MavenImportingTestCase {
	...
	public void testImplementHealthCheck() throws Exception {
		...
		VirtualFile javaFile = LocalFileSystem.getInstance().refreshAndFindFileByPath(ModuleUtilCore.getModuleDirPath(module) + "src/main/java/org/acme/config/GreetingResource.java");

		diagnosticsParams.setUris(Arrays.asList(javaFile.getUrl()));
